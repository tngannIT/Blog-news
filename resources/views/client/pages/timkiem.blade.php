                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 text-uppercase font-weight-bold">Nội dung tìm kiếm:
                                    {{ isset($_GET['q']) ? $_GET['q'] : '' }} </h4>
                        ...
                        @if ($posts != null || $posts != '')
                            ...
                            @endforeach
                        @else
                            <div class="text-center text-vd">Không có bài viết nào được tìm thấy</div>
                        @endif
